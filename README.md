# Fernstarterpack TypeScript Library
...
const client = new StarterClient({ apiKey: "YOUR_API_KEY" });
...
const request: Starter.EligibilityInquiryRequest = {
    ...
};
```
...
```typescript
const response = await client.eligibilityInquiry.medicareObProcessMain(..., {
    headers: {
